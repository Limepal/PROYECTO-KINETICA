...
class OAuth2LoginSuccessHandlerTest {
    ...
    @Test
    void shouldSetHttpOnlyCookiesAndRedirectWithoutTokensInQuery() throws ServletException, IOException {
        AuthService authService = mock(AuthService.class);
        when(authService.loginWithOAuth("oauth@test.com"))
                .thenReturn(new AuthResponse(5L, "oauth@test.com", "access-123", "refresh-123", "Bearer"));
